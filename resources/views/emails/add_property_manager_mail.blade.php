...
<div id="user-content" style="margin: 17px 0; text-align: center">
  ...
  <div id="user-content" style="margin: 17px 0; text-align: center">
    ...
    >
      ...
      You have been added as the Property Manager for the Property of {{ $landlord }} on this Platform.
      <br>
      @if ($new_user)
  ...
  <div id="user-content" style="margin: 17px 0; text-align: center">
    @if ($new_user)
      <a href="{{ env('FRONTEND_URL') }}/activate-account?verification_token={{ $token }}&role=property manager"><button
        style="
