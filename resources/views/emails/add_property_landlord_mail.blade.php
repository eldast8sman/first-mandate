                    ...
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                        ...
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                            You have been added as the Landlord of a Property managed by {{ $manager }} on 1st Mandate App.
        
                            @if ($new_user)
                                In order to have full access to your account, please click on the link below
                            
                                <p>
                                    <a href="{{ env('FRONTEND_URL') }}/activate-account?verification_token={{ $token }}&role=landlord">Activate Account</a>
                                </p>
                            @else
